...
<body>
    <?php
        ...
        if ($_SERVER["REQUEST_METHOD"] === "POST") {
            ...
            $stageDescription = $_POST["stageDescription"];

            $sql = "INSERT INTO stages (project_id, stage_name, description) VALUES ('$projectId', '$stageName', '$stageDescription')";
    ...
    <main>
        ...
        <form action="<?php echo $_SERVER['PHP_SELF'] . '?project_id=' . $projectId; ?>" method="post">
            ...
            <textarea id="stageDescription" name="stageDescription" rows="4" required></textarea>
